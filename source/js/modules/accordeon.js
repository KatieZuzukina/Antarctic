...
const classActive = 'footer-navigation__title--active';
...
const handleClickItem = (e) => {
  ...
  if (window.innerWidth < 767) {
    allItems.forEach((elem) => {
      elem.classList.remove('footer-navigation__title--active');
    });
    ...
    if (!isOpened) {
      item.classList.add('footer-navigation__title--active');
